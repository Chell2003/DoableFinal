...
namespace DoableFinal.Controllers
{
    ...
    public partial class ProjectManagerController : Controller
    {
        ...
        [HttpGet]
        public async Task<IActionResult> Tasks(string? q = "", string? statusFilter = "", string? categoryFilter = "", string? fromDate = "", string? toDate = "")
        {
            var currentUser = await _userManager.GetUserAsync(User);
            if (currentUser?.Id == null)
            {
        ...
        public async Task<IActionResult> MyProjects(string? q = "", string? statusFilter = "", string? categoryFilter = "", string? fromDate = "", string? toDate = "")
        {
            var currentUser = await _userManager.GetUserAsync(User);
            if (currentUser?.Id == null)
            {
